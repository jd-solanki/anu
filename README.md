...
- ⚙️ **[Configurable UI](https://anu-vue.netlify.app/guide/base-components/typography.html#config-array)** - Customize rendered UI via configurable array instead of writing component markup again
