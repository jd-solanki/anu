...
const themeShortcuts: Exclude<Preset['shortcuts'], undefined> = [
  ...
  // 👉 Grid
    ...
    // 👉 Button
    'a-btn': 'px-[1em] font-medium rounded-[0.5em] gap-x-[0.5em] h-[2.5em] focus-visible:ring-2 ring-offset-2',
    'a-btn-icon-only': 'font-medium rounded-lg h-[2.5em] w-[2.5em] i:em:text-lg focus-visible:ring-2 ring-offset-2',
