...
export const ACheckbox = defineComponent({
    ...
    setup(props, { slots, attrs, emit }) {
        ...
        return () => <label class={['inline-flex items-center cursor-pointer']} for={elementId}>
            ...
            />
            <div class={[
                "h-5 w-5 border-(2 [hsla(var(--base-color),var(--border-opacity))] rounded)  flex items-center justify-center shrink-0 transition transition-border duration-200 mr-2",
