...
export const ABtn = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    return () => <button class={[props.iconOnly ? 'btn-icon-only' : 'btn', 'uno-layer-base-text-base inline-flex justify-center items-center', { 'opacity-50 pointer-events-none': isEleDisabled(attrs) }, ...getLayerClasses(props)]}>
