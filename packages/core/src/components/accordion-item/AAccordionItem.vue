...
<template>
  <AccordionItem
    :class="[defaultsClass, props.ui?.accordionItem]"
    :style="defaultsStyle"
    v-bind="defaultsAttrs"
    class="a-accordion-item"
    :value="accordionItemValue"
    :disabled="props.disabled"
  >
    <AccordionHeader
      class="a-accordion-header"
      :class="props.ui?.accordionHeader"
    >
      <AccordionTrigger
        class="a-accordion-trigger"
        :class="props.ui?.accordionTrigger"
      >
        <slot name="before-title" />
        <!-- ℹ️ Can we use radix slot here? -->
        <slot name="title">
          <span
            class="a-accordion-title"
            :class="props.ui?.accordionTitle"
          >{{ props.title }}</span>
        </slot>
    ...
    <AccordionContent
      class="a-accordion-content"
      :class="props.ui?.accordionContent"
    >
      <div
        class="a-accordion-content-child"
        :class="props.ui?.accordionContentChild"
      >
        <slot />
      </div>
    </AccordionContent>
