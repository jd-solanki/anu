...
const shortcuts: Exclude<Preset['shortcuts'], undefined | StaticShortcutMap> = [
  ...
  ],
  {
    ...
    'overlay': 'absolute inset-0 content-empty bg-[hsl(var(--a-loader-overlay-bg-c) / var(--a-loader-overlay-bg-opacity))] opacity-0 rounded-inherit transition-opacity transition-duration-250',
